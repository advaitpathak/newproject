...
SUBMIT_ARGS = "--packages org.apache.hudi:hudi-spark-bundle_2.12:0.11.0 pyspark-shell"
os.environ['PYSPARK_SERIALIZE_PICKLE'] = 'false'
...
spark = SparkSession.builder \
    .appName("YourAppName") \
    .config("spark.serializer", "org.apache.spark.serializer.KryoSerializer") \
    .config("spark.kryo.registrator", "your.custom.registrator.Class") \
    .config("spark.sql.hive.convertMetastoreParquet", "false") \
    .config("spark.sql.extensions", "org.apache.spark.sql.hudi.HoodieSparkSessionExtension") \
    .config("spark.sql.warehouse.dir", "file:///C:/tmp/spark_warehouse") \
    .getOrCreate()

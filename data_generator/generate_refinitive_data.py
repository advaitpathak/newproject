...
for _ in range(num_records):
    ...
    # Generate random values for each property in the schema
...
filename = "refinitive_data_10k.json"
with open(filename, "w") as file:
    json.dump(records, file, indent=4)

print(f"Generated {num_records} records and saved them to '{filename}'.")
